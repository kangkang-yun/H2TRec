...
class GRDataset(Dataset):
	def __init__(self, data, u_items_list, u_users_list, u_users_items_list, i_users_list, sf_list, sf_user_item_list, i_items_friend_list, if_item_users_list, u_fans_list, u_fans_items_list, neg_transh_list):
		self.data = data
		...
		self.u_fans_list = u_fans_list
		self.u_fans_items_list = u_fans_items_list
	...
	def __getitem__(self, index):
		...
		u_fans = self.u_fans_list[uid]
		u_fans_items = self.u_fans_items_list[uid]

		return (uid, iid, label), u_items, u_users, u_users_items, i_users, sf_users, sf_user_items, if_item_friends, if_items_users, u_fans, u_fans_items, neg_train_list
